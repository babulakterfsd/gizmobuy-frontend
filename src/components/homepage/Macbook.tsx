...
const Macbook = () => {
  ...
  return (
    <div className="mt-14 lg:mt-20 bg-[#FFE7D6] p-6 lg:p-16 flex flex-col lg:flex-row justify-between items-center space-y-4">
      {/* description */}
      <div className="">
        ...
        <p className="my-4 text-custom-black text-lg font-thin w-full lg:w-6/12">
          {macbook?.description.slice(0, 150)}
        </p>
        <button
          className="bg-orange py-2.5 px-6 rounded text-white font-semibold flex items-center gap-x-2 hover:bg-orange-500 mt-6"
